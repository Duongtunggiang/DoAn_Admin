                                    ...
                                    <div class="card-body">
                                        <form>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small" href="${pageContext.request.contextPath}/admin-forgot-pass.jsp">Forgot Password?</a>
                                                <a class="btn btn-primary" href="${pageContext.request.contextPath}/admin.jsp">Login</a>
                                            </div>
                                        </form>
                                    </div>
